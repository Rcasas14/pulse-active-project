    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 md:p-0 xs:p-0">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex-shrink-0 pl-4">
          <a href="/"><h1 class="text-[36px] text-[#f97316] font-bold">Pulse Active</h1></a>
        </div>
       ...
       <transition name="slide">
        <div v-if="mobileMenuOpen" class="lg:hidden overflow-hidden" @click.stop>
          <div class="px-2 pt-2 pb-3 space-y-1 bg-[#f97316]">
            ...
            <a href="/classes" class="text-white hover:text-gray-200 block px-3 py-2 text-base font-medium">
              Classes
            </a>
            <a href="/members" class="text-white hover:text-gray-200 block px-3 py-2 text-base font-medium">
              Members
            </a>
            <a href="/trainers" class="text-white hover:text-gray-200 block px-3 py-2 text-base font-medium">
              trainers
            </a>
            <a href="/contact" class="text-white hover:text-gray-200 block px-3 py-2 text-base font-medium">
              Contact
            </a>
